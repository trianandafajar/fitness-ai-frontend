  ...
  return (
    <div className="mt-2.25 flex gap-2">
      ...
      <button
        ...
        onClick={handleAdd}
        disabled={!value.trim()}
        className="rounded-[10px] bg-orange px-4 text-sm font-semibold text-white transition-colors hover:bg-orange-deep disabled:cursor-not-allowed disabled:opacity-50"
      >
        + Add
      </button>
    </div>
