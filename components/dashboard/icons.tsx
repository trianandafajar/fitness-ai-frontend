...
export function IconProgress({ className = "h-4.5 w-4.5" }: IconProps) {
  return (
    ...
    >
      <path d="M3 3v18h18" />
      <path d="M18.4 8.6l-5.1 5.1-3-3L6.4 14.6" />
    </svg>
  );
}
...
export function IconCheckin({ className = "h-4.5 w-4.5" }: IconProps) {
  return (
...
export function IconNotification({ className = "h-4.5 w-4.5" }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export function IconKpi({ className = "h-4.5 w-4.5" }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
