...
export const APP_NAME = process.env.NEXT_PUBLIC_APP_NAME || "Athletica"
...
export const API_BASE_URL = process.env.NEXT_PUBLIC_API_URL || "https://api.athletica.app"
export const REVERB_HOST = process.env.NEXT_PUBLIC_REVERB_HOST || "reverb.athletica.app"
